            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= 33) {
                    ...
                    if (ContextCompat.checkSelfPermission(applicato_successo.this,
                        ...
                        dialog.setMessage("Veuillez autoriser les notifications pour cette application afin que vous " +
                                "soyez averti lorsque votre prêt est prêt");
                        dialog.setPositiveButton("D'ACCORD", new DialogInterface.OnClickListener() {
                            @Override
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= 33) {
                    ...
                    if (ContextCompat.checkSelfPermission(applicato_successo.this,
                        ...
                        AlertDialog.Builder dialog = new AlertDialog.Builder(applicato_successo.this);
                        dialog.setMessage("Veuillez autoriser les notifications pour cette application afin que " +
                                "vous soyez averti lorsque votre prêt est prêt");
                        dialog.setPositiveButton("D'ACCORD", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
