...
public class principale2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hmwelcome.setText("Bienvenue " + lname );
        upcloan.setText("€ " + applied + ",00");
        limittxt.setText("€ " + limit + ",00");
        hmbalance.setText("Équilibre: €" + balance );
        ...
        if (!Conectivity.isConnectingToInternet(principale2.this)) {
            Toast.makeText(principale2.this, "S'il vous plait, vérifiez votre connexion internet", Toast.LENGTH_SHORT).show();
        }
