        ...
        Morelgtbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!Conectivity.isConnectingToInternet(lista_delle_vivande.this)) {
                    Toast.makeText(lista_delle_vivande.this, "S'il vous plait, vérifiez votre connexion internet", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(lista_delle_vivande.this, "Déconnecté", Toast.LENGTH_SHORT).show();
